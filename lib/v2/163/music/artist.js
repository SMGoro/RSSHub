        ...
        item: data.hotAlbums.map((item) => {
            ...
            return {
                ...
                description: art(path.join(__dirname, '../templates/music/playlist.art'), {
                    ...
                    iframe: ` <br> <iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width=100% height=450 src="https://music.163.com/outchain/player?type=1&id=${item.id}&auto=0&height=430"></iframe>`,
                    picUrl: item.picUrl,
                }),
