...
module.exports = async (ctx) => {
    ...
    ctx.state.data = {
        ...
        description: `网易云音乐 - 歌手歌曲 - ${artist.name} <br> <iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width=100% height=86 src="https://music.163.com/outchain/player?type=2&id=${song.id}&auto=0&height=66"></iframe>`,
        item: items,
    };
};
