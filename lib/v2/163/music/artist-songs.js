...
module.exports = async (ctx) => {
    ...
    const items = data.songs.map((song) => ({
        ...
        description: art(path.join(__dirname, '../templates/music/playlist.art'), {
            ...
            album: song.al.name,
            iframe: ` <br> <iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width=100% height=86 src="https://music.163.com/outchain/player?type=2&id=${song.id}&auto=0&height=66"></iframe>`,
